...
![Die Seitenstruktur]({{% asset "images/manual/introduction/de/die-seitenstruktur.png" %}}?classes=shadow)
...
![Die Frontend-Module]({{% asset "images/manual/introduction/de/die-frontend-module.png" %}}?classes=shadow)
