...
| Absolute URL | {{< version "4.11" >}} Allows users to enter absolute URLs (starting with `http://` or `https://`). |
| Custom | {{< version "4.11" >}} Allows users to enter text according to the given custom regular expression. |
