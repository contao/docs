...
![Mehrere Datensätze bearbeiten]({{% asset "images/manual/layout/administration-area/de/mehrere-datensaetze-bearbeiten.png" %}}?classes=shadow)
...
![Die zu bearbeitenden Eingabefelder auswählen]({{% asset "images/manual/layout/administration-area/de/die-zu-bearbeitenden-eingabefelder-auswaehlen.png" %}}?classes=shadow)
...
![Nur die ausgewählten Eingabefelder werden angezeigt]({{% asset "images/manual/layout/administration-area/de/nur-die-ausgewaehlten-eingabefelder-werden-angezeigt.png" %}}?classes=shadow)
...
![Auswahl des Update-Modus beim Überschreiben von Datensätzen]({{% asset "images/manual/layout/administration-area/de/auswahl-des-update-modus-beim-ueberschreiben-von-datensaetzen.png" %}}?classes=shadow)
...
![Frühere Versionen eines Datensatzes wiederherstellen]({{% asset "images/manual/layout/administration-area/de/fruehere-versionen-eines-datensatzes-wiederherstellen.png" %}}?classes=shadow)
...
![Unterschiede zwischen den gewählten Versionen]({{% asset "images/manual/layout/administration-area/de/unterschiede-zwischen-den-gewaehlten-versionen.png" %}}?classes=shadow)
