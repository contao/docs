...
| `{{ua::*}}`              | Eigenschaften des Browsers (User Agent) ausgeben: `{{ua::browser}}`. Dies wird beispielsweise ersetzt mit "chrome". (deprecated since **Contao 4.13**, not available anymore in **Contao 5.0**)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
