...
| `{{acronym::*}}`         | Akronyme in einem Text markieren: `{{abbr::Multipurpose Internet Mail Extensions}}MIME{{abbr}}`. Dies wird ersetzt mit `<abbr title="Multipurpose Internet Mail Extensions">MIME</abbr>`. |
