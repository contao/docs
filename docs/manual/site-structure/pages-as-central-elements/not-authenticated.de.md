---
title: "401 Nicht authentifiziert"
description: " Diese Seite wird aufgerufen, wenn ein Mitglied nicht angemeldet ist und deshalb nicht auf eine geschützte 
Seite zuzugreifen darf. Du kannst die Seite wahlweise als reguläre Seite nutzen und einen entsprechenden Hinweis 
...
Diese Seite wird aufgerufen, wenn ein Mitglied nicht angemeldet ist und deshalb nicht auf eine geschützte Seite 
zuzugreifen darf. Du kannst die Seite wahlweise als reguläre Seite nutzen und einen entsprechenden Hinweis ausgeben oder 
den Besucher automatisch z. B. auf die Anmeldeseite weiterleiten.
...
**Zu einer anderen Seite weiterleiten:** Den Besucher zu einer anderen Seite weiterleiten (z. B. einer Login-Seite).
