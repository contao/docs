...
description: 'This page is called when a root page is in maintenance mode. Maintenance mode can be enabled in the 
Website root.'
url: "site-structure/service-unavailable"
aliases:
    - /en/site-structure/pages-as-central-elements/service-unavailable/
    - /en/layout/site-structure/pages-as-central-elements/service-unavailable/
weight: 90
---


This page is called when a root page is in maintenance mode. Maintenance mode can be enabled in the 
[Website root](/en/site-structure/pages-as-central-elements/website-root/).
