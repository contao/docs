...
| [GD][ext-gd] (`ext-gd`)                   | **erforderlich** | erfordert 7, 8 oder 9    |
| [Imagick][ext-imagick] (`ext-imagick`)    | _nicht benutzt_  | erfordert 7, 8 oder 9    |
| [Gmagick][ext-gmagick] (`ext-gmagick`)    | _nicht benutzt_  | erfordert 7, 8 oder 9    |
