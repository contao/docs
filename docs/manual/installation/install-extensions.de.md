...
![Erweiterungssuche im Contao Manager](/de/installation/images/de/erweiterungssuche-im-contao-manager.png?classes=shadow)
...
![Erweiterungen im Contao Manager suchen](/de/installation/images/de/erweiterungen-im-contao-manager-suchen.png?classes=shadow)
...
![Erweiterungen im Contao Manager installieren](/de/installation/images/de/erweiterungen-im-contao-manager-installieren.png?classes=shadow)
...
![Erweiterungen im Contao Manager installiert](/de/installation/images/de/erweiterungen-im-contao-manager-installiert.png?classes=shadow)
...
{{% notice note %}}
Alternativ kannst du dafür das [Contao Install-Tool](../contao-installtool/) nutzen.
{{% /notice %}}