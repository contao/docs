...
The system requirements are basically the same as for [Contao](../../installation/systemvoraussetzungen). The Contao Manager automatically checks if the requirements are met.
