...
mit dem Doppelpunkt. Bei Verwendung der `config.yml` muß die jeweiliege Kodierung eines Sonderzeichen mit % eingeleitet werden: Also z.B. %%23 für das Sonderzeichen #.
{{% /notice %}}
