...
Within the Contao Managed Edition you can store environment specific parameters (e.g. database or SMTP credentials) in
the `parameters.yaml` file. This file needs to be created in the `config/` subfolder and could look like this for
example:
