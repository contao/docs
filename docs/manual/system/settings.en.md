...
`_contao/cron` using a real cron job (which you have to set up yourself). You can also
...
The bundle configuration belongs in the `config.yml` and is located in the folder `config/`. If the file does not 
