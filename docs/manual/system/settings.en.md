...
After that you can test the mail dispatch on the command line. However, first you need to install the
[`inspiredminds/contao-mailer-command`](https://packagist.org/packages/inspiredminds/contao-mailer-command) package.
