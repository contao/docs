...
{{% notice note %}}
Seit 01.10.2021 nutzen wir nicht mehr Mumble für unsere regelmäßigen Contao Calls, sondern die Huddle-Funktion des [Slack Channels](https://to.contao.org/slack).
{{% /notice %}}
