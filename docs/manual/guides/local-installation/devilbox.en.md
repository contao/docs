...
- `HTTPD_DOCROOT_DIR=DOCUMENT-ROOT` (DOCUMENT-ROOT = `public` (until and with Contao 4.11 `web`), also see [hosting-configuration](https://docs.cont- `HTTPD_SERVER=apache-2.4`
- `PHP_SERVER=8.2`
