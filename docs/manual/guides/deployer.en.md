...
As you know [from the Contao documentation][5], you have to set the document root of the server to `/public` of the project. The idea of Deployer is to provide updates with the shortest possible downtime, 
