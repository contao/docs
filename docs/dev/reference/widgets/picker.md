...
| `eval.multiple` | `bool` | Set this to true if you want to be able to select multiple values. |
| `eval.isSortable` | `bool` | When used with `'multiple' => true`, allows for manual reordering using drag-n-drop. |
