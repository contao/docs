...
| search                                                         | true/false (`bool`)                             | If true, the field will be included in the search menu (see [_Sorting_ » `panelLayout`]({{% relref "reference/dca/list" %}}#:~:text=panelLayout)) as well as the backend search.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| backendSearch                                                  | true/false (`bool`)                             | {{< version-tag "5.7" >}} If set, overrides `search` for the backend search only.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| sorting                                                        | true/false (`bool`)                             | If true, the field will be included in the sorting menu (see [_Sorting_ » `panelLayout`]({{% relref "reference/dca/list" %}}#:~:text=panelLayout)).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| filter                                                         | true/false (`bool`)                             | If true, the field will be included in the filter menu (see [_Sorting_ » `panelLayout`]({{% relref "reference/dca/list" %}}#:~:text=panelLayout)).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| [options_callback]({{% relref "callbacks/#fields-field-options" %}}) | Callback function (`array`)               | Callback function that returns an array of options. Please specify as `['Class', 'Method']`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| [input_field_callback]({{% relref "callbacks/#fields-field-input-field" %}}) | Callback function (`array`)       | Executes a custom function instead of using the default input field routine and passes the the DataContainer object and the label as arguments.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| eval                                                           | Field configuration (`array`)                   | Various configuration options. See next paragraph.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [wizard]({{% relref "callbacks/#fields-field-wizard" %}})      | Callback functions (`array`)                    | Call a custom function and add its return value to the input field. Please specify each callback as `['Class', 'Method']`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| sql                                                            | Database field definition (`string` or `array`) | Describes data type and its database configuration. (see paragraph [SQL Column Definition](#sql-column-definition)). {{< version-tag "5.7" >}} If omitted, the field will automatically be treated as a virtual field (see [Virtual Fields](#virtual-fields)).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| relation                                                       | Configuration of relations (`array`)            | Describes relation to parent table (see paragraph [Relations](#relations)).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| targetColumn                                                   | Storage column (`string`)                       | {{< version-tag "5.7" >}} Defines the JSON storage column for a virtual field (see paragraph [Virtual Fields](#virtual-fields)). Default `jsonData`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| [load_callback]({{% relref "callbacks/#fields-field-load" %}}) | Callback functions (`array`)                    | These functions will be called when the field is loaded. Please specify each callback function as `['Class', 'Method']`. Passes the field's value and the data container as arguments. Expects the field value as return value.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| [save_callback]({{% relref "callbacks/#fields-field-save" %}}) | Callback functions (`array`)                    | These functions will be called when the field is saved. Please specify each callback function as `['Class', 'Method']`. Passes the field's value and the data container as arguments. Expects the field value as return value. Throw an exception to display an error message.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| [xlabel]({{% relref "callbacks/#fields-field-xlabel" %}})      | Callback functions (`array`)                    | These functions will be called when the widget is rendered and allows you to add additional html after the field label. Please specify each callback function as `['Class', 'Method']`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| [attributes_callback]({{% relref "callbacks#fields-field-attributes" %}}) | Callback functions (`array`)         | Allows you do dynamically adjust the attributes of a field in a DCA before a widget is generated. Please specify as `['Class', 'Method']` or use service tagging.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
...
| colorpicker             | true/false (`bool`)                       | If true, the current field will have a color picker.                                                                                                                                                                                                                                               |
...
| dcaPicker               | true/false/Configuration (`bool`/`array`) | If true, the general purpose picker will be shown. Allows to pick different records from the system and return them as an insert tag. Can be [customized](reference/dca/fields/#dca-picker-fields) by passing an array.                                                                            |
...
| feEditable              | true/false (`bool`)                       | If true, the current field can be used in the front end for the registration and personal data modules. Applies to table `tl_member` only.                                                                                                                                                         |
| feGroup                 | Group name (`string`)                     | Defines in which section of the registration and personal data form the field should appear:<br>**personal** personal data <br>**address** address details <br>**contact** contact details <br>**login** login details <br>You can also define your own groups. Applies to table `tl_member` only. |
...
| showFilePreview         | true/false (`bool`)                       | If true, regular files within the `fileTree` widget will also be shown as images.                                                                                                                                                                                                                         |
...
To do so, set an array instead of a boolean as value to `dcaPicker`.

The configured insert tag must contain a `%s` placeholder, which will be replaced
with the picked value.

```php
// contao/dca/tl_example.php
$GLOBALS['TL_DCA']['tl_example']['fields']['myfield']['eval']['dcaPicker'] = [
    'insertTag' => '{{link_url::%s|absolute}}',
];
```

This applies the same insert tag template to all DCA picker providers enabled for
the field. To configure individual picker providers separately, use the provider
name as the key:
...
Provider specific options take precedence over the general options. Picker providers
can access these values via `PickerConfig::getExtraForProvider()`, which falls
back to the general configuration if no provider specific value exists.
...
| `['type' => 'string', 'length' => 64, 'default' => '', 'customSchemaOptions' => ['collation' => 'ascii_bin']]`<br>{{< version-tag "5.6" >}} `['type' => 'string', 'length' => 64, 'default' => '', 'platformOptions' => ['collation' => 'ascii_bin']]` | `VARCHAR(64) COLLATE ascii_bin NOT NULL default ''` |

## Virtual Fields

{{< version "5.7" >}}

Virtual fields allow you to define DCA fields without adding a new database column. Instead, their values are
automatically serialized into a single JSON column (default `jsonData`) and are accessible through the
[Model][Model].
This solves a long-standing problem where tables (e.g. `tl_content` and `tl_module`) would eventually hit the technical
database row size limit as more and more fields are added when installing extensions. Storing multiple field values
together in one place removes that constraint entirely.

Any field without an SQL definition will automatically be treated as a virtual field. See
[Automapping limitations](#automapping-limitations) for cases where the `targetColumn` has to be defined manually.
...
Any virtual field is accessible via the Model (`$objModel->foobar`) and can also be saved using the Model class.

### Automapping Limitations

The following tables and fields are excluded from auto-mapping, the
[`VirtualFieldsMappingListener`][VirtualFieldsMappingListener] will not process them:

- DCAs that are managed via a Doctrine entity
- DCAs set to `notEditable` or that don't have any palettes (e.g., `tl_job`)
- Fields with an `input_field_callback` (as they might not need a storage like `serpPreview`)
- Fields with a `save_callback` (fields might redirect the storage elsewhere)

If virtual field support is still needed in those cases, [targetColumn](#target-column) can be defined manually.

### Target Column

The storage column defaults to `jsonData` but can be overridden using the eval option `targetColumn`. Having a custom
storage column set will automatically create a migration with the `JSON` data type.
This can be useful to group your own fields within an extension, e.g. a foobar column to keep it separated.
...
{{% notice note %}}
Filtering and searching for virtual fields is only supported within `DC_Table` (see [#9814](https://github.com/contao/contao/pull/9814)).
Fields that require this outside of `DC_Table` still need a dedicated database column.
{{% /notice %}}
...
[Model]: /dev/framework/models/
[VirtualFieldsMappingListener]: https://github.com/contao/contao/blob/5.7/core-bundle/src/EventListener/VirtualFieldsMappingListener.php
