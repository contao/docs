...
| feEditable              | true/false (`bool`)                       | If true, the current field can used in the front end for the registration and personal data modules. Applies to table `tl_member` only.                                                                                                                                                                                                             |
| feGroup                 | Group name (`string`)                     | Defines in which section of the registration and personal data form the field should appear:<br>**personal** personal data <br>**address** address details <br>**contact** contact details <br>**login** login details (table `tl_member` only) <br>You can also define your own groups. Applies to table `tl_member` only. |
