...
| feGroup                 | Group name (`string`)                     | Makes this field available for the registration form and defines in which section of the form the field should appear:<br>**personal** personal data <br>**address** address details <br>**contact** contact details <br>**login** login details (table `tl_member` only) <br>You can also define your own groups. Applies to table `tl_member` only. |
