...
| reverseToggle        | true/false (`bool`)                             | {{< version-tag "5.0" >}} If true the `toggle` action is reversed.                                                                                                                                                                                                               |
...
| alwaysSave         | true/false (`bool`)           | If true the field will always be saved, even if its value has not changed. This can be useful in conjunction with a [load callback]({{% ref "callbacks#fields-field-load" %}}). |
