...
| defaultSearchField    | Field name (`string`)            | {{< version-tag "5.1" >}} Set a default search field for the search records menu instead of selecting the alphabetically first field. The specified field's value will also be used as a fallback for the automatically generated breadcrumb, instead of just showing a generic label.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
