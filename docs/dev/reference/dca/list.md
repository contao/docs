...
| [panel_callback](../callbacks#list-sorting-panel-callback-subpanel) | Callback function (`array`) | This callback allows you to inject HTML for custom panels. Nested array with your custom panel’s name as a key. Please specify as `['Class', 'Method']` or use an anonymous function.
