...
| defaultSearchField    | Field name (`string`)            | {{< version-tag "5.1" >}} Set a default search field for the search records menu instead of selecting the alphabetically first field. In addition it makes the breadcrumb show this field's value instead of the generic "Edit element ID ...".                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
