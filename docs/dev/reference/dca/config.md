...
| markAsCopy                                                           | Field name (`string`)             | Appends "(copy)" to this field when copying a record.                                                                                                                |
| uploadPath                                                           | Folder name (`string`)            | Path to the root folder of the file manager.                                                                                                                         |
| validFileTypes                                                       | File extensions (`string`)        | Limits the file manager to certain file types (comma separated list).                                                                                                |
| editableFileTypes                                                    | File extensions (`string`)        | Limits the file types that can be edited with the source code editor (comma separated list).                                                                         |
...
| hideVersionMenu                                                      | true/false (`bool`)               | If true, the version dropdown is hidden.                                                                                                                             |
...
| backendSearchIgnore                                                  | true/false (`bool`)               | {{< version-tag "5.7" >}} Only relevant when using `DC_Table` as data container. If true, the data is exempt from the backend search.                                |
| [oncreate_callback]({{% relref "callbacks#config-oncreate" %}})      | Callback functions (`array`)      | Calls a custom function when a new record is created and passes the table, the insert id, the data array and the DataContainer object as argument.                   |
| [onload_callback]({{% relref "callbacks#config-onload" %}})          | Callback functions (`array`)      | Calls a custom function when a DataContainer is initialized and passes the DataContainer object as argument.                                                         |
| [onbeforesubmit_callback]({{% relref "callbacks#config-onbeforesubmit" %}}) | Callback functions (`array`)      | Calls a custom function before a DataContainer is submitted and passes the DataContainer object as argument.                                                         |
| [onsubmit_callback]({{% relref "callbacks#config-onsubmit" %}})      | Callback functions (`array`)      | Calls a custom function after a record has been updated and passes the DataContainer object as argument.                                                             |
| [ondelete_callback]({{% relref "callbacks#config-ondelete" %}})      | Callback functions (`array`)      | Calls a custom function when a record is deleted and passes the DataContainer object as argument.                                                                    |
| [oncut_callback]({{% relref "callbacks#config-oncut" %}})            | Callback functions (`array`)      | Calls a custom function when a record is moved and passes the DataContainer object as argument.                                                                      |
| [oncopy_callback]({{% relref "callbacks#config-oncopy" %}})          | Callback functions (`array`)      | Calls a custom function when a record is duplicated and passes the insert ID and the DataContainer object as argument.                                               |
| [onundo_callback]({{% relref "callbacks#config-onundo" %}})          | Callback functions (`array`)      | Calls a custom function when a deleted record has been restored from the "undo" table.                                                                               |
| [oncreate_version_callback]({{% relref "callbacks#config-oncreate-version" %}})    | Callback functions (`array`)      | Calls a custom function when a new version of a record is created and passes the table, the insert ID and the DataContainer object as argument.                      |
| [onrestore_version_callback]({{% relref "callbacks#config-onrestore-version" %}}) | Callback functions (`array`)      | Calls a custom function when a version of a record is restored and passes the table, insert ID, the table, the version and the data array as argument.               |
| [onpalette_callback]({{% relref "callbacks#config-onpalette" %}})    | Callback functions (`array`)      | {{< version-tag "5.3" >}}Calls a custom function when a palette is built to edit a record and passes the generated palette and the DataContainer object as argument. |
