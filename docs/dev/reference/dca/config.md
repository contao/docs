...
| [onpalette_callback](../callbacks/#config-onpalette)                 | Callback functions (`array`)      | {{< version-tag "5.3" >}}Calls a custom function when a palette is built to edit a record and passes the generated palette and the DataContainer object as argument.                                                    |
