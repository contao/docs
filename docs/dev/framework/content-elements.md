...
* __Service Tag__ <br>
  ...
  * __Category__ <br>
    All content elements are categorised within the type dropdown of the content element's palette. The default category
...
this content element. Now we create a basic [Twig template][TwigTemplates] for the output:
