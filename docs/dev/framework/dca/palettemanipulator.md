...
$GLOBALS['TL_DCA']['tl_user'] = [
    ...
    'palettes' => [
        …
        'default' => '{name_legend},username,name,email;{backend_legend:collapsed},language,uploader,showHelp,thumbnails,useRTE,useCE;{theme_legend:collapsed},backendTheme,fullscreen;{password_legend:collapsed},pwChange,password;{admin_legend},admin;{groups_legend},groups,inherit;{account_legend},disable,start,stop'
        …
    ],
    …
];
