...
control on how the application is built during an update. Hence, if you want to install e.g. Contao {{% siteparam "currentContaoLtsVersion" %}}, you would require
`contao/manager-bundle` in `{{% siteparam "currentContaoLtsVersion" %}}.*`.
